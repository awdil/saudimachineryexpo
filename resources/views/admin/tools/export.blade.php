			...
			<div class="card-body">
				<div class="basic-form">
					<div class="row align-items-center">
						<div class="col-12">
							<p class="m-0">{{ __('When you click the button below PakCMS will create an XML file of your content for you to save to your computer.') }}</p>
							<p class="m-0">{{ __('This format will contain your posts, pages, comments, custom fields, categories, and tags.') }}</p>
							<p class="m-">{{ __('Once you’ve saved the download file, you can use the Import function in another PakCMS installation to import the content from this site.') }}</p>
