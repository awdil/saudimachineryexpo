	...
	<div class="row page-titles mx-0 mb-3">
		<div class="col-sm-6 p-0">
			<div class="welcome-text">
				<h4>{{ __('Catalogues') }}</h4>
				<span>{{ __('All Catalogues list') }}</span>
			</div>
		</div>
		...
		<div class="col-xl-12">
			<div class="card accordion accordion-rounded-stylish accordion-bordered" id="search-sec-outer">
				<div class="accordion-header rounded-lg {{ $collapsed }}" data-bs-toggle="collapse" data-bs-target="#rounded-search-sec">
                    ...
                    <h4 class="accordion-header-text m-0">{{ __('Search Catalogues') }}</h4>
		...
		<div class="col-xl-12">
			<div class="card">
						...
						<table class="table table-responsive-lg mb-0">
							<thead class="">
								<tr>
									...
									@canany(['Controllers > CatalogueController > admin_edit', 'Controllers > CatalogueController > admin_destroy'])
							...
							<tbody>
								...
								@empty
									<tr><td class="text-center" colspan="7"><p>{{ __('No Catalogues found.') }}</p></td></tr>
								@endforelse
				...
				<div class="card-footer">
                    {{-- {{ $catalogues->onEachSide(2)->appends(Request::input())->links() }} --}}
				</div>
			</div>
		</div>
	</div>
