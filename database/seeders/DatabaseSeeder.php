...
class DatabaseSeeder extends Seeder
{
    ...
    function defaultConfiguration()
    {
        $data = [
            ...
            [
                'name'          => 'Site.tagline',
                'value'         => 'PakCMS - Laravel CMS System',
                'title'         => Null,
                'description'   => Null,
                'input_type'    => 'textarea',
                'editable'      => 1,
            ...
            [
                'name'          => 'Site.copyright',
                'value'         => '<strong class="text-dark">PakCMS</strong> Copyright © 2022 All Rights Reserved',
            ...
            [
                ...
                'value'         => 'Developed by <a href="https://www.pakindustrialexpo.com/\" target=\"_blank\">pakindustrialexpo</a>',
                'title'         => 'Footer text',
                'description'   => Null,
                'input_type'    => 'textarea',
                'editable'      => 1,
            ...
            [
                ...
                'value'         => 'pakindustrialexpo/bodyshape',
                'title'         => '',
                'description'   => '',
                'input_type'    => 'radio',
                'editable'      => 1,
                'weight'        => 31,
                'params'        => ':default,pakindustrialexpo/bodyshape:Theme 1',
                'order'         => 31
            ],
            [
                'name'          => 'Site.icon_logo',
